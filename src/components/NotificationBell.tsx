...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 md:left-0 md:right-auto mt-2 w-[min(92vw,380px)] max-h-[70vh] overflow-hidden rounded-xl border border-border bg-card shadow-xl z-[60]">
